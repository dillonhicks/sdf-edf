...
#ifndef edfup1_LOCAL_DSUI_H
#define edfup1_LOCAL_DSUI_H
...
extern struct datastream_ip __start___edfup1_datastream_ips[];
extern struct datastream_ip __stop___edfup1_datastream_ips[];

#define DSUI_BEGIN(argcp, argvp) \
    dsui_start((argcp), (argvp), "/tmp/edfup1.dsui.bin");
...
#define DSTRM_EVENT_DATA(gname, ename, tag, data_len, data, edfname) do {    \
    ...
    __attribute__((section("__edfup1_datastream_ips"), aligned(8))) =            \
    {                                    \
