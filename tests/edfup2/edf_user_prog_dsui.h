...
#ifndef edf_user_prog_LOCAL_DSUI_H
#define edf_user_prog_LOCAL_DSUI_H
...
extern struct datastream_ip __start___edf_user_prog_datastream_ips[];
extern struct datastream_ip __stop___edf_user_prog_datastream_ips[];

#define DSUI_BEGIN(argcp, argvp) \
    dsui_start((argcp), (argvp), "/tmp/edf_user_prog.dsui.bin");
...
#define DSTRM_EVENT_DATA(gname, ename, tag, data_len, data, edfname) do {    \
    ...
    __attribute__((section("__edf_user_prog_datastream_ips"), aligned(8))) =            \
    {                                    \
