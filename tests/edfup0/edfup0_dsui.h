...
#ifndef edfup0_LOCAL_DSUI_H
#define edfup0_LOCAL_DSUI_H
...
extern struct datastream_ip __start___edfup0_datastream_ips[];
extern struct datastream_ip __stop___edfup0_datastream_ips[];

#define DSUI_BEGIN(argcp, argvp) \
    dsui_start((argcp), (argvp), "/tmp/edfup0.dsui.bin");
...
#define DSTRM_EVENT_DATA(gname, ename, tag, data_len, data, edfname) do {    \
    ...
    __attribute__((section("__edfup0_datastream_ips"), aligned(8))) =            \
    {                                    \
