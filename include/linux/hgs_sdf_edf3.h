...
#define SIG_MISSED_DEADLINE   47

struct timespec SDF_EDF_DEFAULT_PERIOD = {
	.tv_sec = 0UL,		
	.tv_nsec = 1000000      
};
 ...
 *     this phase flag is set (SETUP->FINISHED) it will also
...
enum sdf_edf_mp_cmd {
	SDF_EDF_MP_CMD_PERIOD,
	SDF_EDF_MP_CMD_PHASE,
};
